...
describe('StoryEditorComponent', () => {
  ...
  describe('editing', () => {
    ...
    // A Story description is Markdown, and the field that takes it carries the preview.
    ...
    it('offers the writing with a preview beside it', () => {
      ...
      expect(field?.getAttribute('previewclass')).toBe(
        'storytime-story__description',
      );
      expect(element.querySelector('#story-description')).toBeTruthy();
      expect(
        [
